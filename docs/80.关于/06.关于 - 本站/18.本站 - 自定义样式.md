...
![image-20220101215956767](https://cdn.jsdelivr.net/gh/Kele-Bingtang/static/img/%E5%85%B3%E4%BA%8E/%E5%85%B3%E4%BA%8E%E6%9C%AC%E7%AB%99/20220101220000.png)
...
目前本站使用了 `vuepress-plugin-reading-progress` 插件，该插件能显示一个页面的进度条（位于顶部），下面是我用的样式：
...
然后在 docs 目录下的 .vuepress 目录下的 config 目录下的 plugins.js 文件，添加如下内容：
