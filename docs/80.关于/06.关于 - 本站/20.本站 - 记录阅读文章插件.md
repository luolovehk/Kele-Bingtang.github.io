...
本站实现了一个记住阅读文章的插件，方便下次访问本站时，可选择跳转曾经阅读的文章。
...
在 docs 下的 .vuepress 的 components 文件夹下创建 LastReadingPopup.vue 文件，如果没有 components 文件夹，请创建。
...
在 docs 下的 .vuepress 下的 enhanceApp.js 文件里添加如下内容：
